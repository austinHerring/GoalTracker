...
package com.austin.goaltracker.gcm.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ListDevices listDevices(java.lang.String accountId) throws java.io.IOException {
    ListDevices result = new ListDevices(accountId);
    initialize(result);
    return result;
  }

  public class ListDevices extends RegistrationRequest<com.austin.goaltracker.gcm.registration.model.CollectionResponseRegistrationRecord> {

    private static final String REST_PATH = "registrationrecord/{accountId}";
     ...
     * @since 1.13
     */
    protected ListDevices(java.lang.String accountId) {
      super(Registration.this, "GET", REST_PATH, null, com.austin.goaltracker.gcm.registration.model.CollectionResponseRegistrationRecord.class);
    ...
    public ListDevices setAccountId(java.lang.String accountId) {
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String accountId) throws java.io.IOException {
    Register result = new Register(regId, accountId);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{accountId}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String accountId) {
    ...
    public Register setAccountId(java.lang.String accountId) {
      this.accountId = accountId;
      return this;
    }
   ...
   * @return the request
   */
  public Unregister unregister(java.lang.String regId, java.lang.String accountId) throws java.io.IOException {
    Unregister result = new Unregister(regId, accountId);
    initialize(result);
    return result;
  }
  ...
  public class Unregister extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "unregisterDevice/{regId}/{accountId}";
     ...
     * @since 1.13
     */
    protected Unregister(java.lang.String regId, java.lang.String accountId) {
      super(Registration.this, "POST", REST_PATH, null, Void.class);
      this.regId = com.google.api.client.util.Preconditions.checkNotNull(regId, "Required parameter regId must be specified.");
      this.accountId = com.google.api.client.util.Preconditions.checkNotNull(accountId, "Required parameter accountId must be specified.");
    }
    ...
    public Unregister setAccountId(java.lang.String accountId) {
      this.accountId = accountId;
      return this;
    }
