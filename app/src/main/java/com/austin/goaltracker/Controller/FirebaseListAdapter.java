 ...
 * @version 1.0
 *
 * A generic way of binding an Android ListView with a Firebase location.
 *
...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
    ...
    /**
     * @param mRef        The Firebase location to watch for data changes,
     * @param mModelClass Firebase will marshall the data at a location into an instance of a class
     * @param mLayout     This is the layout used to represent a single list item.
    ...
    /**
     * Each time the data at the given Firebase location changes, the method is called for each
